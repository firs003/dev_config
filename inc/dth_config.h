...
#define DTH_CONFIG_BOARD_DEFAULT_TCP_PORT	23335
#define DTH_CONFIG_REMOTE_DEFAULT_TCP_PORT	23336
#define DTH_CONFIG_FILE_TRANFER_TCP_PORT	24000
...
typedef enum dth_config_ack_value {
	...
	DTH_CONFIG_ACK_VALUE_RECV_ERROR,
	DTH_CONFIG_ACK_VALUE_FILE_TRANS_STARTED,
} dth_ack_value_e;
